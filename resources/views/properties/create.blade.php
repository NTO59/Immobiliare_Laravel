...
@section('content')
    <div class="container">
        ...
        <form action="" method="POST">
            @csrf
            {{-- Genere une balise avec le token CSRF. Ce token permet de proteger le site contre les attaques CSRF. Laravel
        va simplement vérifier que le tokeb envoyé correspond à celui de la personne qui est actuellement sur le site --}}
